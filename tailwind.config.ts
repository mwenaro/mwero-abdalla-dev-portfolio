  ...
  theme: {
    extend: {
      colors: {
        ...
        'portfolio-bg-card': 'var(--portfolio-bg-card)',
        'portfolio-bg-hover': 'var(--portfolio-bg-hover)',
        ...
        'portfolio-border-hover': 'var(--portfolio-border-hover)',
        'portfolio-accent': 'var(--portfolio-accent)',
        'portfolio-accent-hover': 'var(--portfolio-accent-hover)',
        'portfolio-accent-light': 'var(--portfolio-accent-light)',
